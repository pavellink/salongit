<div class="modal_block">
    <div class="modal" id="modal_form" style="background: rgba(0, 0, 0, 0.565);">
        ...
        <div class="modal_wrap center">
            <div class="modal_scroll" style="max-width:450px">
                <div class="modal_content">
                    ...
                    <div class="modal_body"><a href="tel:{{$item->phone}}" class="phone">{{$item->phone}}</a>
                        <div class="user_time">{{$item->name}}</div>
                        <div class="phone_text">Представьтесь! Здравствуйте, это [имя] из салон-парикмахерская орхидея...</div>
                        <div class="phone_form">
                            <div class="phone_form_title">Укажите цель звонка</div>
                            <div class="phone_form_btns">
                                <div class="form_btn" onclick="clickFeedback(1)">Записать</div>
                                <div class="form_btn" onclick="clickFeedback(2)">Подтвердить запись</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            function clickFeedback($id){
                $('#modal_form').remove();
                $.post('/get-feedback', {result: $id, feedback_id: 1, _token: '{!! csrf_token() !!}'});
            }
