...
@section('content')
    ...
    <div class="page_content">
        <style>
            .add_btn{display: table;padding: 10px 20px;background: #2572fa;color: #fff;border-radius: 4px;font-size: 15px;margin-left: 12px;position: absolute;top: 30px;right: 40px;}
        ...
        <div class="main_block with_tab" style="position: relative">
            <h1 class="page_title">Услуги</h1>
            <a href="{{route('services.create')}}" class="add_btn">Добавить</a>
            <div class="index_tabs">
                <a href="{{route('services')}}" class="index_tab active" data-tab="1">Все услуги</a>
                <a href="{{route('services.groups')}}" class="index_tab" data-tab="2">Группировка</a>
                <a href="{{route('sets')}}" class="index_tab" data-tab="2">Шаблон для услуг</a>
            </div>
        </div>
        <style>
        ...
        <div class="main_block" style="padding: 0">
            <table>
                ...
                <tbody class="js_html">
                @include('services.items', ['subs' => false, 'sets' => false])
                </tbody>
            </table>
        </div>
