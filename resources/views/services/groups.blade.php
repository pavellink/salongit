    ...
    <div class="page_content">
        ...
        <div class="main_block with_tab" style="position: relative">
            ...
            <div class="index_tabs">
                <a href="{{route('services')}}" class="index_tab" data-tab="1">Все услуги</a>
                <a href="{{route('services.groups')}}" class="index_tab active" data-tab="2">Группировка</a>
            </div>
        </div>
        <style>
        ...
        <div class="main_block" style="padding: 0">
            <table>
                ...
                <tbody class="js_html">
                @include('services.items', ['subs' => true, 'sets' => false])
                </tbody>
            </table>
        </div>
